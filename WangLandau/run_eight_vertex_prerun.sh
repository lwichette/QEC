...
xval=$size
yval=$size
timeout $time_limit ./prerun_eight_vertex_-10 -x 4 -y 8 --prob_x 0.1 --prob_y 0.1 --prob_z 0.1 --nit $iterations --nl 100 -w 5 --seed $seed_hist --num_intervals 3  --replicas $num_interactions
if [ $? -eq 124 ]; then
